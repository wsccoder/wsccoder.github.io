...
**8 进入到 相应的集群容错方案 类中  因为我们使用的默认配置，所以 我们将会是[FailoverClusterInvoker](https://github.com/wsccoder/incubator-dubbo/blob/master/dubbo-cluster/src/main/java/org/apache/dubbo/rpc/cluster/support/FailoverClusterInvoker.java) 这个类**

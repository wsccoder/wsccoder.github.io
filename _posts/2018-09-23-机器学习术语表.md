...
[**梯度下降法**](http://wsccoder.top/2018/09/23/机器学习术语表/#梯度下降法-gradient-descent)的很多变体都一定能找到一个接近严格凸函数最小值的点。同样，[**随机梯度下降法**](http://wsccoder.top/2018/09/23/机器学习术语表/#随机梯度下降法-sgd-stochastic-gradient-descent)的很多变体都有很高的可能性能够找到接近严格凸函数最小值的点（但并非一定能找到）。
...
与[**参数**](http://wsccoder.top/2018/09/23/机器学习术语表/#参数-parameter)相对。
...
另请参阅[**平移不变性**](http://wsccoder.top/2018/09/23/机器学习术语表/#平移不变性-translational-invariance)和[**旋转不变性**](http://wsccoder.top/2018/09/23/机器学习术语表/#rotational_invariance)。
...
请参阅[**池化**](http://wsccoder.top/2018/09/23/机器学习术语表/#池化-pooling)。
...
在 TensorFlow 中的某一[**步**](http://wsccoder.top/2018/09/23/机器学习术语表/#步-step)计算出的一个值或一组值，通常用于在训练期间跟踪模型指标。
...
根据输入数据及其对应的[**标签**](http://wsccoder.top/2018/09/23/机器学习术语表/#label)来训练[**模型**](http://wsccoder.top/2018/09/23/机器学习术语表/#model)。监督式机器学习类似于学生通过研究一系列问题及其对应的答案来学习某个主题。在掌握了问题和答案之间的对应关系后，学生便可以回答关于同一主题的新问题（以前从未见过的问题）。请与[**非监督式机器学习**](http://wsccoder.top/2018/09/23/机器学习术语表/#非监督式机器学习-unsupervised-machine-learning)进行比较。
...
仅通过[**标准化**](http://wsccoder.top/2018/09/23/机器学习术语表/#标准化-normalization)或[**缩放**](http://wsccoder.top/2018/09/23/机器学习术语表/#scaling)创建的特征不属于合成特征。
...
请参阅[**等级**](http://wsccoder.top/2018/09/23/机器学习术语表/#等级-rank)。
...
[**张量**](http://wsccoder.top/2018/09/23/机器学习术语表/#张量-tensor)在各种维度中包含的元素数。例如，张量 [5, 10] 在一个维度中的形状为 5，在另一个维度中的形状为 10。
...
[**张量**](http://wsccoder.top/2018/09/23/机器学习术语表/#张量-tensor)包含的标量总数。例如，张量 [5, 10] 的大小为 50。
...
与[**训练集**](http://wsccoder.top/2018/09/23/机器学习术语表/#训练集-training-set)和[**验证集**](http://wsccoder.top/2018/09/23/机器学习术语表/#验证集-validation-set)相对。
...
机器学习和统计学的一个子领域，旨在分析[**时态数据**](http://wsccoder.top/2018/09/23/机器学习术语表/#时态数据-temporal-data)。很多类型的机器学习问题都需要时间序列分析，其中包括分类、聚类、预测和异常检测。例如，您可以利用时间序列分析根据历史销量数据预测未来每月的冬外套销量。
...
确定构成模型的理想[**参数**](http://wsccoder.top/2018/09/23/机器学习术语表/#参数-parameter)的过程。
...
与[**验证集**](http://wsccoder.top/2018/09/23/机器学习术语表/#验证集-validation-set)和[**测试集**](http://wsccoder.top/2018/09/23/机器学习术语表/#测试集-test-set)相对。
...
另请参阅[**大小不变性**](http://wsccoder.top/2018/09/23/机器学习术语表/#大小不变性-size-invariance)和[**旋转不变性**](http://wsccoder.top/2018/09/23/机器学习术语表/#rotational_invariance)。
...
被模型正确地预测为[**负类别**](http://wsccoder.top/2018/09/23/机器学习术语表/#负类别-negative-class)的样本。例如，模型推断出某封电子邮件不是垃圾邮件，而该电子邮件确实不是垃圾邮件。
...
被模型正确地预测为[**正类别**](http://wsccoder.top/2018/09/23/机器学习术语表/#正类别-positive-class)的样本。例如，模型推断出某封电子邮件是垃圾邮件，而该电子邮件确实是垃圾邮件。
...
与[**召回率**](http://wsccoder.top/2018/09/23/机器学习术语表/#召回率-recall)的含义相同，即：
...
包含[**特征**](http://wsccoder.top/2018/09/23/机器学习术语表/#特征-feature)但没有[**标签**](http://wsccoder.top/2018/09/23/机器学习术语表/#label)的样本。无标签样本是用于进行[**推断**](http://wsccoder.top/2018/09/23/机器学习术语表/#推断-inference)的输入内容。在[**半监督式**](http://wsccoder.top/2018/09/23/机器学习术语表/#semi-supervised_learning)和[**非监督式**](http://wsccoder.top/2018/09/23/机器学习术语表/#非监督式机器学习-unsupervised-machine-learning)学习中，在训练期间会使用无标签样本。
...
请与[**监督式机器学习**](http://wsccoder.top/2018/09/23/机器学习术语表/#监督式机器学习-supervised-machine-learning)进行比较。
...
与[**训练集**](http://wsccoder.top/2018/09/23/机器学习术语表/#训练集-training-set)和[**测试集**](http://wsccoder.top/2018/09/23/机器学习术语表/#测试集-test-set)相对。
...
一种线性模型，通常有很多[**稀疏输入特征**](http://wsccoder.top/2018/09/23/机器学习术语表/#sparse_features)。我们之所以称之为“宽度模型”，是因为这是一种特殊类型的[**神经网络**](http://wsccoder.top/2018/09/23/机器学习术语表/#神经网络-neural-network)，其大量输入均直接与输出节点相连。与深度模型相比，宽度模型通常更易于调试和检查。虽然宽度模型无法通过[**隐藏层**](http://wsccoder.top/2018/09/23/机器学习术语表/#隐藏层-hidden-layer)来表示非线性关系，但可以利用[**特征组合**](http://wsccoder.top/2018/09/23/机器学习术语表/#特征组合-feature-cross)、[**分桶**](http://wsccoder.top/2018/09/23/机器学习术语表/#分桶-bucketing)等转换以不同的方式为非线性关系建模。
